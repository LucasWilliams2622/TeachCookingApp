...
const ItemMatching = () => {
  return (
    <View style={[appStyle.boxShadow, { borderWidth: 0.5, marginRight: 5, paddingVertical: 22,marginBottom:3 ,width: 820, marginTop: 16 }]}>
            ...
            <View style={[appStyle.column, { alignItems: 'flex-start', marginTop: 15 }]}>
                <Text style={[appStyle.normalText, { fontSize: 10, }]}>Departure date</Text>
                <Text style={[appStyle.text, { fontSize: 14, }]}>09:20 am, 15/06/2023</Text>
            </View>
            <View style={[appStyle.column, { alignItems: 'flex-start', marginTop: 15 }]}>
                <Text style={[appStyle.normalText, { fontSize: 10, }]}>Price</Text>
                <Text style={[appStyle.text, { fontSize: 14, }]}>2.300.000đ</Text>
            </View>
        </View>
  )
}
