...
const ItemFinished = (props) => {

  const { data } = props;
  const { orderCode, date, nameCustomer, pickupLocation, destination, totalPrice } = data;
  return (
    <View style={[appStyle.boxShadow, appStyle.column, { alignItems: 'flex-start', paddingVertical: 28, paddingHorizontal: 18, marginBottom: 32,width:'100%', }]}>
      <View style={[appStyle.row,{justifyContent:'space-between',alignItems:"center",width:"100%"}]}>
        ...
        <Image source={require('../../../assets/icons/5star.png')} />
      </View>
