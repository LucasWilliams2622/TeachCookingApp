            ...
            <View style={appStyle.row}>
                ...
                <View style={[appStyle.column, { top: showDrawer ? -10 : 0, flex: 1, alignItems: 'flex-start', marginVertical: 32, marginHorizontal: 20, }]}>
                    <View style={[appStyle.row, { alignItems: 'center', marginBottom: 30 }]}>
                        ...
                        <Text style={[appStyle.text, { color: COLOR.titleBreadCrumb }]}>Detail</Text>
                    </View>
                        ...
                        <View style={[appStyle.column, { alignSelf: 'center', }]}>
                            <View style={[appStyle.column, { alignItems: 'flex-start', }]}>
                                ...
                                <View style={[appStyle.textInput, { marginTop: 7 }]}>
                                    <TextInput style={{ backgroundColor: COLOR.black, width: 500 }} placeholder='Enter new title'defaultValue={"Thông báo"} />
                            ...
                            <View style={[appStyle.column, { alignItems: 'flex-start', marginTop: 36, }]}>
                                ...
                                <View style={[appStyle.textInput, { marginTop: 7, }]}>
                                    <TextInput style={{ backgroundColor: COLOR.black, width: 500, height: 300, textAlign: 'left', paddingLeft: 12, paddingVertical: 20, textAlignVertical: "top" }} placeholderTextColor={COLOR.normalText} placeholder='Enter new content' defaultValue={"Chương trình giảm giá cực sốc..."}  />
                                </View>
                            </View>
                            ...
                            <View style={{ marginTop: 36, width: 500, marginBottom: 100 }}>
                                <ButtonPrimary title={"Update"} onPress={() => { }} />
                            </View>
                        </View>
                    </ScrollView>
                </View>
