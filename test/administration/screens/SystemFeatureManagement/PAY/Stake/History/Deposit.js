...
const Deposit = () => {
  ...
  const widthArr = [90, 120, 120, 100, 100, 100, 130];

  let array = myData.SFM_PAY_Wallet_History.map(obj => [obj.id, obj.date, obj.quantity, obj.depositor, obj.currency, obj.ref, obj.status,]);
  ...
  return (
    <SafeAreaView style={[appStyle.column, { width: windowWidth - 490, height: windowHeight - 120,alignItems: "flex-start", marginTop: 40,  }]}>
