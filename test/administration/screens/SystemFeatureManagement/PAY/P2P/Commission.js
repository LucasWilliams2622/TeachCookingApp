import { SafeAreaView, StyleSheet, Text, ScrollView, Alert,View, Image, Switch, TouchableOpacity } from 'react-native'
...
const Commission = () => {
    ...
    return (
        <SafeAreaView style={[appStyle.boxSysFeature, { width: windowWidth - 500, marginLeft: 1, height: windowHeight - 260 ,marginTop:40}]}>
            ...
            <TouchableOpacity style={styles.buttonPlus} onPress={()=>{handleButtonPress('AddCommission ./AddCommission')}}  >
