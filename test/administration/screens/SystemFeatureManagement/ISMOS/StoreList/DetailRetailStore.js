        ...
        <ScrollView style={[appStyle.boxSysFeature, { marginLeft: 100,width:windowWidth-480,    }]} showsVerticalScrollIndicator={false}>
           <Switch
            ...
            <View style={appStyle.column}>
                ...
                <Text style={[appStyle.textMoney, { color: COLOR.text, marginTop: 25 }]}>Lam Thảo Cosmetics</Text>
                ...
                <View style={[appStyle.row, { alignItems: 'flex-start', }]}>
                    <TouchableOpacity style={[appStyle.column, { marginRight: 70, }]}>
                        <View style={styles.bgItem}>
                            <Image style={appStyle.bigIcon} source={require('../../../../assets/icons/ic_box.png')} />
                        </View>
                        <Text style={[appStyle.text, { fontSize: 18, marginTop: 7 }]}>Product</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[appStyle.column, { marginRight: 70 }]}>
                        <View style={styles.bgItem}>
                            <Image style={appStyle.bigIcon} source={require('../../../../assets/icons/ic_computer.png')} />
                        </View>
                        <Text style={[appStyle.text, { fontSize: 18, marginTop: 7 }]}>Sales Channel</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[appStyle.column, { marginRight: 70 }]}>
                        <View style={styles.bgItem}>
                            <Image style={appStyle.bigIcon} source={require('../../../../assets/icons/ic_cashier.png')} />
                        </View>
                    ...
                    <TouchableOpacity style={[appStyle.column, { marginRight: 70 }]}>
                        <View style={styles.bgItem}>
                            <Image style={appStyle.bigIcon} source={require('../../../../assets/icons/ic_calender.png')} />
                        </View>
...
export default DetailRetailStore
